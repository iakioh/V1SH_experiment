...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    thisExp.addData('SubjectResponse.keys',SubjectResponse.keys)
    if SubjectResponse.keys != None:  # we had a response
        thisExp.addData('SubjectResponse.rt', SubjectResponse.rt)
        thisExp.addData('SubjectResponse.duration', SubjectResponse.duration)
    thisExp.nextEntry()
